...
# look at list and get largest number (max_int)
# look at each individual integer 
# see what's the difference between the integer and the max. integer
# keep track of all the differences between integers
